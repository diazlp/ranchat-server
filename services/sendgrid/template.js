function emailTemplate(fullName, verificationCode) {
...
body {font-family: 'Muli', sans-serif;}
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
          <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:10px;" width="300" alt="" data-proportionally-constrained="true" data-responsive="false" src="https://i.ibb.co/RzV6TXz/Ran-Chat-logo.png" height="85">
        </td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 43px">Welcome to <span style="color:#AE1DF3; font-weight:600">Ran</span><span style="color:#A031F0; font-weight:600">Chat</span>, ${fullName}!</span></div><div></div></div></td>
      </tr>
    </tbody>
  </table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="a10dcb57-ad22-4f4d-b765-1d427dfddb4e" data-mc-module-version="2019-10-22">
    <tbody>
      <tr>
        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 18px">Please verify your email password to proceed</span><span style="color: #000000; font-size: 18px; font-family: arial, helvetica, sans-serif"> </div><br/>
<div style="font-family: inherit; text-align: center"><span style="color: #A031F0; font-size: 18px"><strong>Thank you!</strong></span></div><br/><div style="font-family: inherit; text-align: center"><span style="color: #000000; font-size: 18px; font-family: arial, helvetica, sans-serif"><em>Your verification code:</em></span><span style="font-size: 18px"></span></div><div></div></div></td>
      </tr>
    </tbody>
