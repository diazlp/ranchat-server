...
router.delete("/conversation/:roomfriendid", MessageController.deleteRoomFriend); //delete RoomFriend

router.post("/addmessage", upload.single("image"), MessageController.addMessage); //add message
